'''
Modified for usage by Asymptoto
Changes:
  dst directory will be created if it doesn't exist
  File will be written to dst file while decompressing instead of being cached in memory
